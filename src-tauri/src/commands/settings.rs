...
use crate::core::settings::backup;
use crate::core::settings::config::AppConfig;
...
pub async fn backup_database(db: State<'_, Database>, output_path: String) -> AppResult<String> {
    ...
    let validated_path = backup::validate_backup_restore_path(&output_path, false)?;
...
pub async fn restore_database(db: State<'_, Database>, backup_path: String) -> AppResult<()> {
    ...
    let backup_path_buf = backup::validate_backup_restore_path(&backup_path, true)?;
